...
import { LogOut, Shield, Users, UserPlus, BookOpen, PlusCircle, GraduationCap, CheckCircle, XCircle, Calendar as CalendarIcon, Clock, Fingerprint } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-[#0B090F] text-slate-900 dark:text-purple-50 font-sans p-4 sm:p-6 lg:p-8 flex flex-col relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-12 gap-4 flex-grow">
        ...
        <div className="xl:col-span-3 bg-white/80 backdrop-blur-md rounded-[2rem] border border-white/50 p-6 flex flex-col items-center justify-center shadow-xl shadow-purple-900/5 hover:-translate-y-1 transition-transform relative overflow-hidden group">
          <span className="text-slate-400 dark:text-purple-500 text-[10px] font-bold uppercase tracking-widest mb-2 flex items-center"><Shield className="w-4 h-4 mr-1" /> Total Admins</span>
        ...
        <div className="xl:col-span-3 bg-white/80 backdrop-blur-md rounded-[2rem] border border-white/50 p-6 flex flex-col items-center justify-center shadow-xl shadow-purple-900/5 hover:-translate-y-1 transition-transform relative overflow-hidden group">
          <span className="text-slate-400 dark:text-purple-500 text-[10px] font-bold uppercase tracking-widest mb-2 flex items-center"><GraduationCap className="w-4 h-4 mr-1" /> Total Students</span>
        ...
        <div className="xl:col-span-3 bg-white/80 backdrop-blur-md rounded-[2rem] border border-white/50 p-6 flex flex-col items-center justify-center shadow-xl shadow-purple-900/5 hover:-translate-y-1 transition-transform relative overflow-hidden group">
          <span className="text-slate-400 dark:text-purple-500 text-[10px] font-bold uppercase tracking-widest mb-2 flex items-center"><Users className="w-4 h-4 mr-1" /> Total Lecturers</span>
        ...
        <div className="xl:col-span-3 bg-white/80 backdrop-blur-md rounded-[2rem] border border-white/50 p-6 flex flex-col items-center justify-center shadow-xl shadow-purple-900/5 hover:-translate-y-1 transition-transform relative overflow-hidden group">
          <span className="text-slate-400 dark:text-purple-500 text-[10px] font-bold uppercase tracking-widest mb-2 flex items-center"><BookOpen className="w-4 h-4 mr-1" /> Active Courses</span>
                ...
                <div key={student.id} className="p-4 bg-white/10 border-2 border-white/10 rounded-2xl flex items-center justify-between hover:border-white/30 transition-colors">
                  <div>
                    <div className="flex items-center space-x-3 mb-1">
                      <span className="px-2 py-0.5 bg-purple-100 dark:bg-purple-900/40 text-purple-900 text-[10px] font-black rounded-md">{student.matric_number || 'NO MATRIC'}</span>
        ...
        {/* Create Admin Form */}
        <div className="md:col-span-2 xl:col-span-4 bg-white dark:bg-[#15111D] rounded-3xl border-2 border-slate-200 dark:border-[#2C2142] p-6 flex flex-col shadow-sm dark:shadow-none">
          <h2 className="text-sm font-bold text-slate-800 dark:text-purple-100 uppercase tracking-widest mb-6">Create Admin</h2>
          
          {adminMessage.text && (
            <div className={`mb-6 p-4 rounded-xl flex items-start ${adminMessage.type === 'success' ? 'bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300 border-2 border-green-200' : 'bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-300 border-2 border-red-200'}`}>
          ...
          <form onSubmit={handleCreateAdmin} className="space-y-4 flex-grow">
            <div>
              <label className="block text-xs font-bold text-slate-700 dark:text-purple-200 uppercase tracking-wider mb-2">Full Name</label>
              <input
                type="text"
                required
                value={newAdminName}
            ...
            <div>
              <label className="block text-xs font-bold text-slate-700 dark:text-purple-200 uppercase tracking-wider mb-2">Email address</label>
              <input
                type="email"
                required
                value={newAdminEmail}
            ...
            <div>
              <label className="block text-xs font-bold text-slate-700 dark:text-purple-200 uppercase tracking-wider mb-2">Password</label>
              <input
                type="password"
                required
            ...
            <button
              ...
              className="w-full flex justify-center items-center py-4 px-4 rounded-xl shadow-sm dark:shadow-none text-sm font-bold text-white bg-purple-900 hover:bg-purple-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 disabled:opacity-50 transition-colors mt-6"
            >
        ...
        <div className="md:col-span-2 xl:col-span-4 bg-white dark:bg-[#15111D] rounded-3xl border-2 border-slate-200 dark:border-[#2C2142] p-6 flex flex-col shadow-sm dark:shadow-none">
          <h2 className="text-sm font-bold text-slate-800 dark:text-purple-100 uppercase tracking-widest mb-6">Create Lecturer</h2>
          
          {lecturerMessage.text && (
            <div className={`mb-6 p-4 rounded-xl flex items-start ${lecturerMessage.type === 'success' ? 'bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300 border-2 border-green-200' : 'bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-300 border-2 border-red-200'}`}>
          ...
          <form onSubmit={handleCreateLecturer} className="space-y-4 flex-grow">
            ...
            <div>
              <label className="block text-xs font-bold text-slate-700 dark:text-purple-200 uppercase tracking-wider mb-2">Staff ID</label>
              <input
                type="text"
                required
            ...
            <div className="space-y-3 flex-grow overflow-y-auto pr-2">
              {lecturers.map((lecturer) => (
                <div key={lecturer.id} className="p-4 bg-white/10 border-2 border-white/10 rounded-2xl flex items-center justify-between hover:border-white/30 transition-colors">
                  <div>
                    <div className="flex items-center space-x-3 mb-1">
                      <span className="px-2 py-0.5 bg-purple-100 dark:bg-purple-900/40 text-purple-900 text-[10px] font-black rounded-md">{lecturer.staff_id || 'NO ID'}</span>
        ...
        <div className="md:col-span-2 xl:col-span-4 bg-white dark:bg-[#15111D] rounded-3xl border-2 border-slate-200 dark:border-[#2C2142] p-6 flex flex-col shadow-sm dark:shadow-none">
          <h2 className="text-sm font-bold text-slate-800 dark:text-purple-100 uppercase tracking-widest mb-6">Create New Course</h2>
          
          {message.text && (
            <div className={`mb-6 p-4 rounded-xl flex items-start ${message.type === 'success' ? 'bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300 border-2 border-green-200' : 'bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-300 border-2 border-red-200'}`}>
          ...
          <form onSubmit={handleCreateCourse} className="space-y-4 flex-grow">
            <div>
              <label className="block text-xs font-bold text-slate-700 dark:text-purple-200 uppercase tracking-wider mb-2">Course Code</label>
              <input
                type="text"
                required
                value={newCourseCode}
                ...
                className="w-full pl-4 pr-4 py-3 text-sm font-medium border-2 border-slate-200 dark:border-[#2C2142] focus:outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-500 rounded-xl bg-slate-50 dark:bg-[#0B090F] text-slate-900 dark:text-purple-50 placeholder-slate-400 transition-colors uppercase"
              />
            </div>
            <div>
              <label className="block text-xs font-bold text-slate-700 dark:text-purple-200 uppercase tracking-wider mb-2">Course Title</label>
              <input
                type="text"
                required
            ...
            <div>
              ...
              <select
                ...
                className="w-full pl-4 pr-10 py-3 text-sm font-medium border-2 border-slate-200 dark:border-[#2C2142] focus:outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-500 rounded-xl bg-slate-50 dark:bg-[#0B090F] text-slate-900 dark:text-purple-50 transition-colors appearance-none"
              >
            ...
            <div className="space-y-3 flex-grow overflow-y-auto pr-2">
              {courses.map((course) => (
                <div key={course.id} className="p-4 bg-white/10 border-2 border-white/10 rounded-2xl flex items-center justify-between hover:border-white/30 transition-colors">
                  <div>
                    <div className="flex items-center space-x-3 mb-1">
                      <span className="px-2 py-0.5 bg-purple-100 dark:bg-purple-900/40 text-purple-900 text-[10px] font-black rounded-md">{course.course_code}</span>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-4 mt-4">
        {/* Schedule Class Form */}
        <div className="md:col-span-2 xl:col-span-4 bg-white dark:bg-[#15111D] rounded-3xl border-2 border-slate-200 dark:border-[#2C2142] p-6 flex flex-col shadow-sm dark:shadow-none">
          <h2 className="text-sm font-bold text-slate-800 dark:text-purple-100 uppercase tracking-widest mb-6">Schedule Class</h2>
          
          {scheduleMessage.text && (
            <div className={`mb-6 p-4 rounded-xl flex items-start ${scheduleMessage.type === 'success' ? 'bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300 border-2 border-green-200' : 'bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-300 border-2 border-red-200'}`}>
          ...
          <form onSubmit={handleCreateSchedule} className="space-y-4 flex-grow">
            <div>
              <label className="block text-xs font-bold text-slate-700 dark:text-purple-200 uppercase tracking-wider mb-2">Select Course</label>
              <select
                required
            ...
            <div>
              <label className="block text-xs font-bold text-slate-700 dark:text-purple-200 uppercase tracking-wider mb-2">Date</label>
              <input
                type="date"
                required
                value={scheduleDate}
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-xs font-bold text-slate-700 dark:text-purple-200 uppercase tracking-wider mb-2">Start Time</label>
                <input
                  type="time"
                  required
              ...
              <div>
                <label className="block text-xs font-bold text-slate-700 dark:text-purple-200 uppercase tracking-wider mb-2">End Time</label>
                <input
                  type="time"
                  required
            ...
            <div>
              <label className="block text-xs font-bold text-slate-700 dark:text-purple-200 uppercase tracking-wider mb-2">Location (Optional)</label>
              <input
                type="text"
