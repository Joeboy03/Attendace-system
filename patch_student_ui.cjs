...
// Fix boxes
content = content.replace(
  /className="bg-white rounded-3xl p-8 border border-slate-200"/g,
  'className="bg-white/80 backdrop-blur-md rounded-[2rem] p-8 border border-white/50 shadow-xl shadow-purple-900/5"'
);
content = content.replace(
  /className="bg-white rounded-3xl p-8 border border-slate-200 flex-grow"/g,
  'className="bg-white/80 backdrop-blur-md rounded-[2rem] p-8 border border-white/50 shadow-xl shadow-purple-900/5 flex-grow"'
);
