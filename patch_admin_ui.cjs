...
// Stat Cards
content = content.replace(
  /className="xl:col-span-3 bg-white rounded-3xl border-2 border-slate-200 p-6 flex flex-col items-center justify-center shadow-sm"/g,
  'className="xl:col-span-3 bg-white/80 backdrop-blur-md rounded-[2rem] border border-white/50 p-6 flex flex-col items-center justify-center shadow-xl shadow-purple-900/5 hover:-translate-y-1 transition-transform relative overflow-hidden group"'
);
content = content.replace(
  /<span className="text-5xl font-black text-purple-900">/g,
  '<span className="text-5xl font-[Space_Grotesk] font-black text-transparent bg-clip-text bg-gradient-to-br from-purple-600 to-indigo-700">'
);
